...
@Component({
  ...
  template: `
    <section class="card json-card">
      ...
      <app-empty-state *ngIf="!data" title="No header yet" description="Decode a token to view its header." ></app-empty-state>
...
export class JwtHeaderPanelComponent {
